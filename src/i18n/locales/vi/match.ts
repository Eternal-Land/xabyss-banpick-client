...
const matchVi: MatchLocaleObject = {
	...
	match_delete_title: "Xóa trận đấu?",
	match_delete_description:
		"Hành động này sẽ xóa trận đấu khỏi danh sách của bạn. Không thể hoàn tác.",
	match_delete_alert_title: "Hành động không thể khôi phục",
	match_delete_alert_description:
		"Xóa trận đấu sẽ gỡ bỏ các ván đấu và dữ liệu khỏi danh sách của bạn.",
	match_delete_cancel: "Hủy",
	match_delete_confirm: "Xóa trận đấu",
	match_delete_success: "Đã xóa trận đấu",
	match_delete_error: "Không thể xóa trận đấu",
